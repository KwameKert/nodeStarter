 ...
 async function clearUsers (){
  ...
  describe('Fetch All Users', () => {
    test('should return 200', async () => {
      let req1 = buildReq({body: {email: 'kwames@gmail.com',  username: 'kwamekert', password: 'password', ConfigurationId: configuration.id}});
      let req2 = buildReq({body: {email: 'kwame@gmail.com',  username: 'kwameker', password: 'password', ConfigurationId: configuration.id}});
      let res1 = buildRes();
  ...
  describe('Fetch  User by id', () => {
    test('should return 200', async () => {
      ...
      let req = buildReq({params: {id: 1}});
      let res = buildRes();
      let nxtFxn = buildNext();
      await UserController.gellUser(req, res, nxtFxn);
      returnExpectations(res, HTTPStatus.OK);
